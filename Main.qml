    ...
    ColumnLayout {
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                Text {
                    // Nilai ini nantinya dikirim dari C++
        ...
        Item { Layout.fillHeight: true } // Spacer bawah agar konten tidak terlalu renggang
    }

    // Properti ini akan dihubungkan dengan logic C++ kamu
